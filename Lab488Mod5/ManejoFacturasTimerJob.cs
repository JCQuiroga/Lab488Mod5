...
namespace Lab488Mod5
{
    public class ManejoFacturasTimerJob : SPJobDefinition
    {
        ...
        public ManejoFacturasTimerJob(string name, SPWebApplication webApplication, SPServer server, SPJobLockType lockType) : base(name, webApplication, server, lockType)
        {
        }
